...
class TestGradients:
    def test_gradcheck(self):
        pytest.skip("ReLUProbAct is stochastic; gradcheck not reliable")
...
class TestInplace:
    def test_inplace_matches_normal(self):
        pytest.skip("ReLUProbAct is stochastic; inplace comparison not meaningful")
